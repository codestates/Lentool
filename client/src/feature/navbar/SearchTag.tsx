  ...
  return (
    <div className="relative bg-white">
      <div className="md:flex space-x-10">
        ...
        <div className={`${isTag} absolute z-10 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2`}>

          <div className='rounded-lg shadow-lg ring-1 ring-black ring-opacity-5'>
            <div className="px-5 py-5 bg-gray-50 space-y-6 sm:flex sm:space-y-0 sm:space-x-10 sm:px-8">
              <div className='grid grid-cols-4 gap-4'>
                <img className="w-12 h-12" src ="https://artfeel.co.kr/web/product/big/o_Icon_027.jpg" />
                <img className="w-12 h-12" src ="https://artfeel.co.kr/web/product/big/o_Icon_027.jpg" />
                <img className="w-12 h-12" src ="https://artfeel.co.kr/web/product/big/o_Icon_027.jpg" />
                <img className="w-12 h-12" src ="https://artfeel.co.kr/web/product/big/o_Icon_027.jpg" />
                <img className="w-12 h-12" src ="https://artfeel.co.kr/web/product/big/o_Icon_027.jpg" />
