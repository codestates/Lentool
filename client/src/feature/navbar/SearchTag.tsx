...
const src = [
  ...
  ["https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQeiCbUU2Fqg5XMazxjdBnsReV2NgMy5rnkIQ&usqp=CAU", 'hexagon_wrench'],
  ...
  ["https://t4.ftcdn.net/jpg/01/91/60/29/240_F_191602951_8FM9lntvbO8iSRNiodIMSwaRfgrj1Rw0.jpg", 'soldering_iron'],
  ["https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSSzxBzuKaQ5XljvZz9WaC2P4_L4NHSW0Sc-w&usqp=CAU", 'long_nose'],
  ...
  return (
    <div className="relative bg-white">
      <div className="md:flex space-x-10">
        ...
        <div className={`${isTag} absolute z-10 -ml-4 mt-3 transform px-2 w-screen max-w-sm sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2`}>
