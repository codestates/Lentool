...
export default function Navbar () {
  ...
  return (
      ...
      <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
        ...
        <div className="relative grow text-gray-600">
          <input type="search" name="search" placeholder="Search"
            className="pt-2 pb-2 border-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-4 pr-12 sm:text-sm border-gray-300 rounded-md" />
    ...
    >
      {
        isLogin ?
        <Menu.Items className="focus:outline-none absolute right-0 xl:right-24 2xl:right-80 mt-2 w-36 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5">
